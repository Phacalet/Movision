...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Activité globale</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Accueil</a></li>
            <li class="breadcrumb-item active">Vision globale</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Trafic réalisé</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Frêts terminés</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Frêts en cours</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Frêts en attente</span>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Trafic annuel</h5>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Tendances mensuelles :</strong> 1 Jan, 2021- 30 Jul, 2021
                  </p>
                ...
                <div class="col-md-4">
                  <p class="text-center">
                    <strong>Chiffres mensuels détaillés</strong>
                  </p>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">transactions en cours</span>
        ...
        <div class="col-md-8">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Derniers Colis</h3>
          ...
          <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
            ...
            <div class="card-tools">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu float-right" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(-5px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
